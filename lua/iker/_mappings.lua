...
wk.register({
	...
	["<C-b>"] = "Go up a page",
	["<C-f>"] = "Go down a page",
	["<C-j>"] = {"<cmd>require('trouble').next({skip_groups = true, jump = true})<cr>", "which_key_ignore"},
	["<C-k>"] = {"<cmd>require('trouble').previous({skip_groups = true, jump = true})<cr>", "which_key_ignore"},
